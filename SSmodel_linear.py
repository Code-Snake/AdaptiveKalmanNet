...
class SystemModel:
    ...
    def __init__(self, F, Q, H, R, T, T_test, prior_Q=None, prior_Sigma=None, prior_S=None, prior_R=None):
    ...
    def GenerateBatch(self, args, size, T, randomInit=False):
        ...
        if (args.randomLength):
            ...
            T_tensor = torch.round(
                (args.T_max - args.T_min) * torch.rand(size)).int() + args.T_min  # Uniform distribution [100,1000]
