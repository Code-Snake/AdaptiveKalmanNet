...
def general_settings():
    ...
    parser.add_argument('--load_model', type=bool, default=False, metavar='load_model',
                        help='if True, load model params')
    parser.add_argument('--save_interval', type=int, default=10, metavar='save_interval',
                        help='params of saving model')
    ...
    parser.add_argument('--other_filter', type=bool, default=False, metavar='load_model',
                        help='if True, other_filter is showing')

    ### KalmanNet settings
    parser.add_argument('--in_mult_KNet', type=int, default=7, metavar='in_mult_KNet',
